						...
						<div class="mod-main">
							<div class="mt">
								<ul class="extra-l">
									...
									<li class="fore-2"><a
										href="javascript:infoImg()">头像照片</a></li>
									<li class="fore-3"><a
									...
									<div class="form">
										...
										<div class="item">
											...
											<div class="fl birthday-info">
												<select name="birthday" class="selt selt1" id="birthdayYear"><option
														value="0" disabled="" selected="selected">请选择：</option>
													...
													<option value="1930">1930</option></select> <label class="ml5 mr5">年</label>
												<select name="" class="selt selt1" id="birthdayMonth"><option
													...
													<option value="12">12</option></select> <label class="ml5 mr5">月</label>
												<select name="" class="selt selt1" id="birthdayDay"><option
														value="1">1</option>
													<option value="2">2</option>
													<option value="3">3</option>
													<option value="4">4</option>
													...
													<option value="28">28</option></select> <label class="ml5 mr5">日</label>
										...
										<div class="item">
											...
											<div class="fl">
												<div>
													<strong> zh*****_j@163.com </strong><a target="_blank"
														class="ml5 ftx05"
										...
										<div class="item">
											...
											<div class="fl">
												<input type="text" class="itxt" maxlength="20"
													name="userVo.realName" id="realName" value="杨炳文">
													<div class="clr"></div>
													<div class="prompt-06">
										...
										<div class="item">
											...
											<div class="fl">
												<select name="userVo.province" class="selt mr5"
													id="province" value="2">
												...
												</select> <select name="userVo.city" class="selt mr5" id="city"
													value="2826"><option value="78">黄浦区</option>
													...
													<option value="2919">崇明县</option></select> <select
													name="userVo.county" class="selt mr5" id="county"
													value="2864"><option value="2864">外环以外</option></select>
												<div class="clr"></div>
												<div class="prompt-06">
										...
										<div class="item">
											...
											<div class="fl">
												<input type="text" class="itxt itxt1" name="userVo.address"
													id="address" value="北京徐汇区内环以内漕溪北路737弄2号楼3201室">
													<div class="clr"></div>
													<div class="prompt-06">
											...
											<div class="fl">
												<input id="code" value="100294" style="display: none">
													...
													style="display: none"> <a href="javascript:void(0)"
														class="btn-5" onclick="updateUserInfo()">提交</a>
											</div>
										</div>
									</div>
								</div>
								<div id="user-info">
									<div class="u-pic">
										<img alt="用户头像" src="/images/defaultImgs/1.jpg">
											<div class="mask"></div>
											<div class="face-link-box"></div> <a
											href="http://i.jd.com/user/userinfo/showImg.html"
