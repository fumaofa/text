 ...
 * Generated at: 2016-09-02 13:05:39 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids,\"status\":3};//,\"_method\":\"DELETE\"\r\n");
      out.write("        \t    \t/* $.ajax({\r\n");
      ...
      out.write("       \t    \t\t   }\r\n");
      out.write("        \t    \t}); */\r\n");
      out.write("                \t$.post(\"/rest/item/status\",params, function(data){\r\n");
      out.write("            \t\t\t//if(data.status == 202){\r\n");
      out.write("            \t\t\t\t$.messager.alert('提示','删除商品成功!',undefined,function(){\r\n");
      out.write("            \t\t\t\t\t$(\"#itemList\").datagrid(\"reload\");\r\n");
      out.write("            \t\t\t\t});\r\n");
      out.write("            \t\t\t//}\r\n");
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids,\"status\":2};\r\n");
      out.write("                \t$.post(\"/rest/item/status\",params, function(data){\r\n");
      out.write("            \t\t\t//if(data.status == 202){\r\n");
      ...
      out.write("        \t    if (r){\r\n");
      out.write("        \t    \tvar params = {\"ids\":ids,\"status\":1};\r\n");
      out.write("                \t$.post(\"/rest/item/status\",params, function(data){\r\n");
      out.write("            \t\t\t//if(data.status == 202){\r\n");
